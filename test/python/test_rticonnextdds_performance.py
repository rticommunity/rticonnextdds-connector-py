...
class TestPerformance:
    ...
    # Test how long it takes to set a sequence of 600000 elements.
    # There are 2 options available:
    # for i in range(0, 600000):
    #   output.instance['myOctSeq[i]'] = 1
    # or
    # output.instance['myOctSeq'] = [1, 2, 3, 4, 5, ....]
    # Test both approaches (expected to be slow until we implement CON-42)
    def test_set_sequence(self, one_use_connector, num_iterations):
        ...
        # Approach 2.
        # Create a python list which contains 600000 and set it in one call
        total_time = 0
        average_time = 0
        myOctSeq = [0]
    ...
    # The use-case of obtainine-case of obtaining a dictionary containing a sequence in Connector
    # is slow, until we implement CON-42
    # Here we have a sequenc with 600000 elements. We time how long it takes to
    # access
